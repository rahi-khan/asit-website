...
const erpServiceData = [
    ...
    { id: 3, title: "Footwear & Garments", type: "garments", imgSrc: garments },
    { id: 4, title: "Healthcare & Diagnostic", type: "healthcare", imgSrc: healthcare },
    { id: 5, title: "Manufacturing(Pharmacy & Othes)", type: "manufacture", imgSrc: manufacture },
    { id: 6, title: "Trading Management", type: "trademanagement", imgSrc: trademanagement },
];

export default erpServiceData;
